...
def generate_alation_metadata(num_assets=None):
    ...
    alation_export = [
        # 1. Schema Asset
        {
            ...
            "stewards": [{"username": "steward.mark@company.com", "email": "steward.mark@company.com"}],
            "popularity": 90,
            "view_count": 820,
            ...
            "data_quality": {"rules_run": 5, "rules_passed": 5, "last_profiled": (now - timedelta(days=1)).isoformat() + "Z"},
            "lineage": {"upstream": [], "downstream": ["alation_101", "alation_102"]},
        },
        # 2. Table Asset: corporate_customers
        {
            ...
            "stewards": [{"username": "sarah.steward@company.com", "email": "sarah.steward@company.com"}],
            "popularity": 95,
            "view_count": 1450,
            ...
            "data_quality": {
                ...
                "dq_metrics": {"null_count": 0, "uniqueness_pct": 100.0, "completeness_pct": 100.0},
            },
            "lineage": {
            ...
            "columns": [
                {
                    ...
                    "is_primary_key": True,
                    "custom_fields": {"PII": "No", "Glossary Term": "Customer Identifier"},
                },
                {
                    "column_id": "101_2",
                    "name": "tax_id_ssn",
                    ...
                    "custom_fields": {"PII": "Yes", "Classification": "Confidential PII", "Glossary Term": "Tax Identifier"},
                },
                {
                    "column_id": "101_3",
                    "name": "credit_limit",
                    ...
                    "is_primary_key": False,
                    "custom_fields": {"PII": "No", "Glossary Term": "Credit Limit"},
                },
            ],
        },
        # 3. Table Asset: transactions_fact
        {
            ...
            "custom_fields": {"PII": "No", "Classification": "Internal", "Glossary Term": "Sales Transaction"},
            "data_quality": {
                "rules_run": 8,
                "rules_passed": 7,  # 87.5% pass rate
                "last_profiled": (now - timedelta(days=1)).isoformat() + "Z",
            },
            "lineage": {"upstream": ["alation_100"], "downstream": ["alation_103"]},
            "columns": [
                {
                    "column_id": "102_1",
                    "name": "transaction_id",
        ...
        # 4. BI Dashboard Asset: customer_credit_report
        {
            ...
            "custom_fields": {"PII": "No", "Classification": "Confidential", "Glossary Term": "Credit Summary Dashboard"},
            "data_quality": {"rules_run": 0, "rules_passed": 0},
            "lineage": {"upstream": ["alation_101", "alation_102"], "downstream": []},
        },
    ...
    if num_assets and num_assets > len(alation_export):
        ...
        while len(alation_export) < target_count:
            ...
            if rules_run > 0:
                ...
                dq = {"rules_run": rules_run, "rules_passed": rules_passed, "last_profiled": last_profiled}
            else:
                dq = {"rules_run": 0, "rules_passed": 0}

            custom_fields = {"Classification": classification, "PII": pii}
