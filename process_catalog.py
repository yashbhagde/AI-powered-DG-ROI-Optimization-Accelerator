...
def main():
    ...
    roi_cols = ["asset_id", "name", "is_rot", "is_sensitive", "realized_discovery_savings", "realized_dq_savings", "realized_risk_savings", "total_realized_savings", "total_opportunity_savings"]
    display_roi_df = roi_df[roi_cols].copy()
    
    # Format currency for print
    for col in ["realized_discovery_savings", "realized_dq_savings", "realized_risk_savings", "total_realized_savings", "total_opportunity_savings"]:
