...
def generate_informatica_metadata(num_assets=None):
    ...
    informatica_export = [
        ...
        # 3. Database Schema Asset: CORE_FINANCE_DB
        {
            ...
            "owners": [{"name": "Robert Miller", "role": "Business Owner", "email": "robert.miller@company.com"}],
            "glossaryAssignments": [],
            "sensitive": False,
            ...
            "lineageInfo": {"upstream": [], "downstream": ["informatica_3001"]},
            "usageStats": {
                "readsCount": 500,
                "usersCount": 5,
        ...
        # 4. Dashboard Asset
        {
            ...
            "owners": [{"name": "Robert Miller", "role": "Business Owner", "email": "robert.miller@company.com"}],
            "glossaryAssignments": [{"termId": "t_103", "termName": "Asset"}],
            "sensitive": False,
            "classification": "Confidential",
            "dqRulesCount": 0,
            "lineageInfo": {"upstream": ["informatica_3005"], "downstream": []},
            "usageStats": {
                "readsCount": 450,
                "usersCount": 12,
                "sizeInBytes": 0,
        ...
        # 5. View Asset
        {
            ...
            "owners": [{"name": "Cloud Data Team", "role": "Technical Owner", "email": "cloud_data@company.com"}],
            "glossaryAssignments": [{"termId": "t_101", "termName": "Transaction"}],
            "sensitive": False,
            "classification": "Internal",
            "dqRulesCount": 5,
            "dqRulesPassed": 5,
            "dqLastRun": (now - timedelta(days=1)).isoformat() + "Z",
            "lineageInfo": {"upstream": ["informatica_3001"], "downstream": ["informatica_3004"]},
            "usageStats": {
                "readsCount": 1200,
                "usersCount": 8,
